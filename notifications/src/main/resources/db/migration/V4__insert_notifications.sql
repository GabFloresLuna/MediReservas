...
(1, 1, 'EMAIL', 'Bienvenida', 'Hola María, bienvenido a MediReservas. Tu cuenta ha sido creada.', 'SENT', '2026-05-15 09:00:00'),
(2, 2, 'SMS', 'Cita confirmada', 'Tu cita con Dr. López ha sido confirmada para el 20 de mayo a las 10:30.', 'SENT', '2026-05-16 14:00:00'),
(3, NULL, 'INTERNAL', 'Aviso del sistema', 'El sistema estará en mantenimiento el domingo de 2:00 a 4:00 AM.', 'PENDING', NULL),
(4, 3, 'EMAIL', 'Cita cancelada', 'Tu cita del 18 de mayo ha sido cancelada. Contacta para reagendar.', 'SENT', '2026-05-17 08:30:00'),
